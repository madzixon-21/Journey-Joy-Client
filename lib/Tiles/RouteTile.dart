...
class RouteTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String visitingHours = calculateVisitingHours(
        attraction.timeNeeded, day, attraction.openHours);
                ...
                decoration: BoxDecoration(
                  ...
                  image: attraction.photo.isNotEmpty
                      ? attraction.photo.startsWith('http')
                          ...
                          : DecorationImage(
                              image:
                                  MemoryImage(base64Decode(attraction.photo)),
                              fit: BoxFit.cover,
                            )
                      : null,
                ),
  ...
  String calculateVisitingHours(
      int timeNeeded, int day, List<List<String>> openingHours) {
    if (openingHours.isEmpty) {
      ...
      int closingHourInMinutes = int.parse(closingHour.substring(0, 2)) * 60 +
          int.parse(closingHour.substring(2, 4));
