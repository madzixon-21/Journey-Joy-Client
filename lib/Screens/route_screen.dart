...
class DragHandleExample extends StatefulWidget {
  const DragHandleExample({required this.trip, Key? key}) : super(key: key);
  final Trip trip;
...
class _DragHandleExample extends State<DragHandleExample> {
  ...
  void initState() {
    super.initState();
    _contents = List.generate(widget.trip.route.attractionsInOrder.length, (index) {
  ...
  Widget build(BuildContext context) {
    var backgroundColor = const Color.fromARGB(255, 219, 235, 199);
